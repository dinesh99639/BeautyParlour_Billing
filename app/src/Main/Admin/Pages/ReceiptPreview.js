            ...
            <>
                ...
                <div style={{padding: "20px 0", paddingTop: "80px"}}>
                    ...
                    <div className="update noprint" style={{textAlign: "center", marginTop: "40px"}}>
                        <Button onClick={()=>{this.props.changePage("previousReceipts")}} style={{margin: "10px", outline: "none", backgroundColor: "#e56219"}} color="primary" variant="contained">Go back</Button>

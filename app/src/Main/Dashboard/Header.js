            ...
            <div className="header" style={{zIndex:1000, position: "fixed", width: "100%"}}>
                <Drawer open={this.state.toggleDrawer} onClose={()=>this.toggleDrawer(false)}>    
                    ...
                    >
                        <div style={{backgroundColor: "rgb(109, 19, 226)", color: "white"}}>
                            <List>
                                ...
                                <ListItem style={{paddingTop: "20px"}}>
                                    <ListItemText>
                                        <Typography style={{fontWeight: "50px"}} variant="h6">Receptioninst</Typography>
                                    </ListItemText>
                                </ListItem>
                            </List>
                        </div>
                        {/* <Divider /> */}
                        <List>
                            <ListItem button onClick={()=>{this.props.changePage("generateReceipts")}}>
                                <ListItemIcon><AssignmentIcon /></ListItemIcon>
                                <ListItemText style={{marginLeft: "-20px"}} primary={"Generate Reciepts"} />
                            </ListItem>
                            <ListItem button onClick={()=>{this.props.changePage("previousReceipts")}}>
                                <ListItemIcon><HistoryIcon /></ListItemIcon>
                                <ListItemText style={{marginLeft: "-20px"}} primary={"Previous Reciepts"} />
                            </ListItem>
                        </List>
                    </div>
                </Drawer>
